        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Return</h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.returns.store') }}" id="main-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker @error('sale_date') is-invalid @enderror" id="sale_date" placeholder="Date" name="sale_date">
                                    @error('sale_date')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="invoice_number">Return Number</label>
                                    <input type="text" class="form-control @error('invoice_number') is-invalid @enderror" id="invoice_number" placeholder="Invoice Number" name="invoice_number">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="safe_id" id="safe_id" class="form-control select2 @error('safe_id') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="warehouse_id" name="warehouse_id" class="form-control @error('warehouse_id') is-invalid @enderror">
                                        ...
                                        @foreach ($warehouses as $warehouse)
                                            <option value="{{ $warehouse->id }}" {{ (string) old('warehouse_id') === (string) $warehouse->id ? 'selected' : '' }}>{{ $warehouse->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('warehouse_id')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="item_id" class="form-control select2">
                                        ...
                                        @foreach($items as $item)
                                            <option data-price="{{$item->price}}" data-quantity="{{$item->quantity}}" value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-1">
                                <button type="button" id="add_item" class="btn btn-primary mb-2 btn-block" style="margin-top: 32px">
                            ...
                            <div class="row">
                                    ...
                                    @foreach($discountTypes as $discountTypeVal => $discountType)
                                        <div class="form-check">
                                            <input class="form-check-input" id="discount{{$discountTypeVal}}" type="radio" name="discount_type"
                                                   value="{{ $discountTypeVal }}" @if(old('discount_type') == $discountTypeVal || $loop->first) checked @endif>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="discount_value" name="discount_value" value="{{ old('discount') }}" placeholder="Discount Value">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" id="payment_type{{\App\Enums\PaymentTypeEnum::cash}}" type="radio" name="payment_type"
                                               value="{{ \App\Enums\PaymentTypeEnum::cash }}" @if(old('payment_type') == \App\Enums\PaymentTypeEnum::cash->value || true) checked @endif>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" id="payment_type{{\App\Enums\PaymentTypeEnum::debt}}" type="radio" name="payment_type"
                                               value="{{ \App\Enums\PaymentTypeEnum::debt }}" @if(old('payment_type') == \App\Enums\PaymentTypeEnum::debt->value) checked @endif>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="payment_amount" name="payment_amount" value="{{ old('payment_amount') }}" @if(!old('payment_amount')) disabled @endif placeholder="Payment Amount">
                                    </div>
                                </div>
                            </div>
                        </div>
