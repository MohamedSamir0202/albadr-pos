    ...
    <div class="col-sm-12">
        <div class="card">
                ...
                <form method="POST" action="{{ route('admin.items.update', $item->id) }}" id="main-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="item_code" id="item_code"
                               ...
                               value="{{ old('item_code', $item->item_code) }}" placeholder="Enter item code">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description"
                                  ...
                                  rows="3" placeholder="Enter description">{{ old('description', $item->description) }}</textarea>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" step="0.01" name="price" id="price"
                                   ...
                                   value="{{ old('price', $item->price) }}" placeholder="Enter price">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" name="minimum_stock" id="minimum_stock"
                                   ...
                                   value="{{ old('minimum_stock', $item->minimum_stock) }}" placeholder="Enter minimum stock">
                        ...
                        @foreach($itemStatuses as $value => $label)
                            <div class="form-check">
                                <input type="radio" name="status" id="status_{{ $value }}" value="{{ $value }}"
                                       class="form-check-input" {{ old('status', $item->status) == $value ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_shown_in_store" id="is_shown_in_store"
                            ...
                            <option value="1" {{ old('is_shown_in_store', $item->is_shown_in_store) == 1 ? 'selected' : '' }}>Yes</option>
                            <option value="0" {{ old('is_shown_in_store', $item->is_shown_in_store) == 0 ? 'selected' : '' }}>No</option>
                        </select>
            ...
            <div class="card-footer">
                <x-form-submit text="Update" form="main-form"></x-form-submit>
