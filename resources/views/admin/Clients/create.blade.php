                    ...
                    <form method="POST" action="{{ route('admin.clients.store') }}" id="main-form">
                            ...
                            @foreach($clientStatuses as $value => $label)
                                <div class="form-check">
                                    <input
                                        ...
                                        name="status"
                                        value="{{ $value }}"
                                        @if(old('status') == $value) checked @endif
                                    >
                        ...
                        <div class="form-group">
                            ...
                            >
                                ...
                                <option value="pos" {{ old('registered_via') == 'pos' ? 'selected' : '' }}>POS</option>
                                <option value="app" {{ old('registered_via') == 'app' ? 'selected' : '' }}>App</option>
                            </select>
