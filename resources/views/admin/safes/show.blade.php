    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">
                    Safe: {{ $safe->name }} — Balance: {{ number_format($safe->balance, 2) }}
                </h3>

                <div class="card-tools">
                    <a href="{{ route('admin.safe-transactions.create', $safe->id) }}" class="btn btn-primary btn-sm">
